# GRAPH:         set of vertices and a collection of edges that connect a pair of vertices
# VERTEX / NODE: points on a graph that can be connected to other vertices
# EDGE:          an edge connects two vertices to show that there is a relationship between them
# WEIGHT:        edges can have weights representing some value/cost between two vertices
